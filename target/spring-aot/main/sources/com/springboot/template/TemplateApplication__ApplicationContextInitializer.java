 ...
 */
@Generated
public class TemplateApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TemplateApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TemplateApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
